...
void TFBroadcaster::drone_measured_position_callback(const geometry_msgs::Vector3 & msg)
{
    ...
    pt_measured_position[0] = msg.x;
    pt_measured_position[1] = msg.y;
    pt_measured_position[2] = msg.z;

    pt_measured_position = ds_pt_->D2Mposition(pt_measured_position);
...
void TFBroadcaster::drone_measured_attitude_callback(const geometry_msgs::Vector3 & msg)
{
    ...
    pt_measured_attitude[0] = msg.x;
    pt_measured_attitude[1] = msg.y;
    pt_measured_attitude[2] = msg.z;
    
    pt_measured_attitude = ds_pt_->D2Mposition(pt_measured_attitude);
...
void TFBroadcaster::drone_paletrone_converter_measured()
{
    ...
    transformStamped_pose.transform.translation.x = pt_measured_position[0];
    transformStamped_pose.transform.translation.y = pt_measured_position[1];
    transformStamped_pose.transform.translation.z = pt_measured_position[2];
    ...
    quat.setRPY(pt_measured_attitude[0], pt_measured_attitude[1], pt_measured_attitude[2]);
